...
role :web, "airline_price.com"                          # Your HTTP server, Apache/etc
role :app, "airline_price.com"                         # This may be the same as your `Web` server
role :db,  "airline_price.com"   , :primary => true # This is where Rails migrations will run
